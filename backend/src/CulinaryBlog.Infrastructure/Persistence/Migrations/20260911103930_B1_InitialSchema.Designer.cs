...
namespace CulinaryBlog.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260911103930_B1_InitialSchema")]
    partial class B1_InitialSchema
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CulinaryBlog.Domain.Entities.Recipe", b =>
                {
                    ...
                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("IDX_Recipe_CreatedAt");
            ...
            modelBuilder.Entity("CulinaryBlog.Domain.Entities.RecipeImage", b =>
                {
                    ...
                    b.HasIndex(new[] { "RecipeId" }, "IDX_RecipeImage_Primary")
                        .IsUnique()
                        .HasFilter("\"IsPrimary\" = true AND \"IsDeleted\" = false");

                    b.HasIndex(new[] { "RecipeId" }, "IDX_RecipeImage_RecipeId");
