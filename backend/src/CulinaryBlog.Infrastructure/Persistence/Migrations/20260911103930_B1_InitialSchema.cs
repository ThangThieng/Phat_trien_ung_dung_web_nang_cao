...
{
    /// <inheritdoc />
    public partial class B1_InitialSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Recipe_CookTime", "\"CookTimeMinutes\" >= 0");
                    table.CheckConstraint("CK_Recipe_PrepTime", "\"PrepTimeMinutes\" > 0");
                    table.CheckConstraint("CK_Recipe_Servings", "\"Servings\" > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_RecipeStep_StepNumber", "\"StepNumber\" > 0");
                    table.CheckConstraint("CK_RecipeStep_TimerMinutes", "\"TimerMinutes\" IS NULL OR \"TimerMinutes\" >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IDX_RecipeImage_RecipeId",
                table: "RecipeImages",
                column: "RecipeId");

            migrationBuilder.CreateIndex(
                name: "IDX_RecipeIngredient_RecipeId",
